...
SPI_TypeDef *mx_spi1_init(void)
{
  ...
  /* LL_GPIO_SetPinOutputType(GPIOB, LL_GPIO_PIN_5 | LL_GPIO_PIN_3 | LL_GPIO_PIN_4, LL_GPIO_OUTPUT_PUSHPULL); */ /* Configuration matches register reset state at startup. */

  /* Activate the Pull-up, Pull-down resistor, or No pull for the current IO */
  /* LL_GPIO_SetPinPull(GPIOB, LL_GPIO_PIN_5, LL_GPIO_PULL_NO); */ /* Configuration matches register reset state at startup. */
...
void mx_spi1_deinit(void)
{
  ...
  /* ### GPIO deinitialization of SPI1: SPI1_MOSI,SPI1_SCK,SPI1_MISO ########################### */
  ...
  LL_GPIO_SetPinOutputType(GPIOB, LL_GPIO_PIN_5 | LL_GPIO_PIN_3 | LL_GPIO_PIN_4, LL_GPIO_OUTPUT_PUSHPULL);
  ...
  LL_GPIO_WriteOutputPin(GPIOB, LL_GPIO_PIN_5 | LL_GPIO_PIN_3 | LL_GPIO_PIN_4, LL_GPIO_PIN_RESET);
}
